...
class BinaryTree
{
    ...
    public:
        ...
        static bool isIdentical(BinaryTree& a, BinaryTree& b);
...
void BinaryTree::isIdentical(BinaryTree& a, BinaryTree& b)
{
    if (a.root == null && b.root == null)
        return true;
    
    isIdentical(a.root, b.root);
}
